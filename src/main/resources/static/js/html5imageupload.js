...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		//buttons
		this.button				= {}
		this.button.edit		= '<div class="btn btn-info btn-edit" title="' + (this.options.editTitle || 'Edit') + '"><i class="bi bi-pen-fill"></i></div>'
		this.button.saving		= '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="bi bi-floppy-fill"></i></div>';
		this.button.zoomin		= '<div class="btn btn-secondary btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><i class="bi bi-zoom-in"></i></div>';
		this.button.zoomout		= '<div class="btn btn-secondary btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><i class="bi bi-zoom-out"></i></div>';
		this.button.zoomreset	= '<div class="btn btn-secondary btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><i class="bi bi-arrows-fullscreen"></i></div>';
//		this.button.rotatecw	= '<div class="btn btn-secondary btn-rotate-cw" title="' + (this.options.cwTitle || 'Rotate clockwise') + '"><i class="glyphicon glyphicon-share"></i></div>';
//		this.button.rotateccw	= '<div class="btn btn-secondary btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="glyphicon glyphicon-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="btn btn-danger btn-cancel" title="' + (this.options.cancelTitle || 'Cancel') + '"><i class="bi bi-x"></i></div>';
		// this.button.done		= '<div class="btn btn-success btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><i class="glyphicon glyphicon-ok"></i></div>';
		this.button.done		= '<div class="btn btn-success btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><i class="bi bi-check"></i></div>';
		this.button.del			= '<div class="btn btn-danger btn-del" title="' + (this.options.delTitle || 'Delete') + '"><i class="bi bi-trash-fill"></i></div>';
		
		this.button.download	= '<a class="btn btn-warning download"><i class="bi bi-download"></i> ' + (this.options.downloadLabel || 'Download') + '</a>';
